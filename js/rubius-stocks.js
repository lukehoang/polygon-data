window.addEventListener('DOMContentLoaded', (event) => {
  ...
  let yearData = [
  	...
  	{ time: '2020-01-01', value: 27.85 },
  	{ time: '2021-01-01', value: 25.65 },
  ];
  ...
  function syncToInterval(interval) {
  	...
  	let data = seriesesData.get(interval);  	
